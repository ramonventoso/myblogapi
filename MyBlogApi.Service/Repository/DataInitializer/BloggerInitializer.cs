...
namespace MyBlogApi.Service
{
    public class BloggerInitializer 
    {
        ...
        public static IEnumerable<Blog> GetBlogs()
        {
            ...
            return _blogs.AsEnumerable();
        }

        public static ICollection<Article> GetChsakellsArticles()
        {
        ...
        public static ICollection<Article> GetDotNETGeeksArticles()
        {
            List<Article> _articles = new List<Article>();
        ...
        public static ICollection<Article> GetAllArticles()
        {
            List<Article> _articles = new List<Article>();
